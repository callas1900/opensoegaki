...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [x] #1 Given the app is running with the window closed via the standard close button (still active in the Dock), when the user clicks the Dock icon, then the app window reopens showing the initial/welcome screen
- [x] #2 Windows behavior is unaffected by the fix
<!-- AC:END -->
...
User confirmed manual verification 2026-07-22: Dock reopen and Windows smoke-test both work as expected.
<!-- SECTION:NOTES:END -->
