...
- [ ] #4 The invitation never overlaps the share bar and never pushes the Choose Photo CTA or the version line off the stage; below a 500px viewport height (phone landscape) it is suppressed instead
<!-- AC:END -->
